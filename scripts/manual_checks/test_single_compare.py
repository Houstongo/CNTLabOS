...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "output" / "manual_checks" / "test_output"


def process_single(img_path, output_dir=DEFAULT_OUTPUT_DIR):
    """处理单张图片，输出对比图"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", "-o", default=str(DEFAULT_OUTPUT_DIR), help="输出目录")
