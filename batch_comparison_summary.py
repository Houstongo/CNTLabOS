...
# 读取两种方法的结果
with open('D:/CNTDATA/CNTA_ML_Project/batch_output_threshold_full/batch_summary.json', 'r', encoding='utf-8') as f:
...
# 保存为CSV
df.to_csv('D:/CNTDATA/CNTA_ML_Project/batch_comparison.csv', index=False, encoding='utf-8-sig')
...
print(f"\n结果已保存至: D:/CNTDATA/CNTA_ML_Project/batch_comparison.csv")
