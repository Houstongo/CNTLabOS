...
- [x] 创建测试页面 `docs/testing/test-modules.html`
...
├── index.html.bak                     # 备份
└── docs/testing/test-modules.html     # 模块加载测试
```
...
- [ ] 在浏览器中打开 `docs/testing/test-modules.html` 验证模块加载
- [ ] 测试各项功能是否正常
- [ ] 修复任何发现的问题
...
### 测试模块加载
直接在浏览器中打开 `d:\CNTDATA\CNTA_ML_Project\docs\testing\test-modules.html`
...
3. 使用 `docs/testing/test-modules.html` 测试单个模块
